...
begin
     ...
     close(trea);
     repeat
           writeln('Koji OS imate? 1 - za XP i prije njega / 2 - za Vistu ili kasnije');
           readln(pom1);
           clrscr;
     until (pom1='1') or (pom1='2');
     repeat
           ...
           if net='' then
               begin
                    ...
                    repeat
                          ...
                          readln(odluka);
                          clrscr;
                    until (upcase(odluka)='D') or (upcase(odluka)='N');
                    if upcase(odluka)='N' then
                       writeln('Sistem nije sinkroniziran sa atomskim satom!!!');
               end;
     until (odluka='dalje') or (upcase(odluka)='N');
...
begin
     repeat
           ...
           clrscr;
           writeln('Vrijeme je: ',alarmtekst,':',pom1,':',pom2);
     until (upcase(izbor)='D') or (upcase(izbor)='N');

     case upcase(izbor) of
     'N':
         begin
              clrscr;
              writeln('Nema alarma.');
